...
namespace Academy.HoloToolkit.Unity.InputModule
{
    ...
    public class GazeManager : Singleton<GazeManager>
    {
        ...
        {
            // 2.a: Assign GazeTransform's position to a new Vector3, newGazeOrigin.
            Vector3 newGazeOrigin = GazeTransform.position;

            // 2.a: Assign GazeTransform's forward to a new Vector3, newGazeNormal.
            Vector3 newGazeNormal = GazeTransform.forward;

            // Update gaze info from stabilizer
            if (Stabilizer != null)
            {
                // 3.a: Using Stabilizer, call function UpdateStability.
                // Pass in newGazeOrigin and GazeTransform's rotation.
                Stabilizer.UpdateStability(newGazeOrigin, GazeTransform.rotation);
                // 3.a: Using Stabilizer, get the StablePosition and assign it to newGazeOrigin.
                newGazeOrigin = Stabilizer.StablePosition;
                // 3.a: Using Stabilizer, get the StableRay's direction and assign it to newGazeNormal.
                newGazeNormal = Stabilizer.StableRay.direction;
            }

            // 2.a: Assign newGazeOrigin to GazeOrigin.
            GazeOrigin = newGazeOrigin;
            // 2.a: Assign newGazeNormal to GazeNormal.
        ...
        private GameObject RaycastPhysics()
        {
            ...
            if (RaycastLayerMasks.Length == 1)
            {
                ...
                // Collect return value in public property IsGazingAtObject.
                // Pass in GazeOrigin as origin and GazeNormal as direction.
                // Collect the information in hitInfo.
                // Pass in MaxGazeCollisionDistance and RaycastLayerMasks[0].
            ...
            if (IsGazingAtObject)
            {
                ...
                // 2.a: Assign property HitPosition to be the HitInfo point.
                HitPosition = HitInfo.point;
                // 2.a: Assign HitObject to be HitInfo.collider.gameObject.
                HitObject = HitInfo.collider.gameObject;
                // 2.a: Assign lastHitDistance to be HitInfo.distance.
            ...
            else
            {
                ...
                // 2.a: Assign HitPosition to be GazeOrigin plus GazeNormal times lastHitDistance.
                HitPosition = GazeOrigin + (GazeNormal * lastHitDistance);
                // 2.a: Assign HitObject to be null, as nothing was hit.
                HitObject = null;
            }
